...
const Teams = ({ color }) => {
  ...
  return (
    <div className="px-10 dark:bg-gray-800">
          ...
          >
            <li className="-mb-px mr-2 md:col-span-4 last:mr-0 flex-auto text-center">
              <a
                className={
                  ...
                  (openTab === "final"
                    ? "text-white dark:text-gray-400 bg-" + color + "-600"
                    : "dark:text-blue-200 text-" + color + "-600 bg-white dark:bg-gray-700")
                }
                onClick={(e) => {
                  e.preventDefault();
                  setOpenTab("final");
            ...
            <li className="-mb-px mr-2 md:col-span-3 last:mr-0 flex-auto text-center">
              <a
                ...
                role="tablist"
              >
                <i className="fas fa-space-shuttle text-base mr-1"></i> App
              </a>
            </li>{" "}
            <li className="-mb-px mr-2 md:col-span-3 last:mr-0 flex-auto text-center">
              <a
                ...
                role="tablist"
              >
                <i className="fas fa-space-shuttle text-base mr-1"></i> Content
                Writing
              </a>
            </li>{" "}
            <li className="-mb-px mr-2 md:col-span-3 last:mr-0 flex-auto text-center">
      ...
      {/* Cards Start Below */}
      <div className="container mx-auto mt-20 pb-10 grid grid-cols-1 gap-8  sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {/* eslint-disable-next-line array-callback-return */}
        {teams.map((member, key) => {
          if (
            member.year === openTab ||
            (member.isWeb && openTab === "web") ||
            (member.isApp && openTab === "app") ||
            (member.isContentWriting && openTab === "content") ||
            (member.isManagement && openTab === "management")
          ) {
            return (
              <div>
                <div className="bg-white dark:bg-gray-900 shadow-md hover:shadow-xl rounded-lg border- p-8">
                  <div>
                    <img
                      className="w-32 h-32 border-4  border-red-400 dark:border-red-700 p-2 rounded-full mx-auto"
                      src={
                        member.image
                          ? `../images/teams/${member.image}.jpg`
                          : avatar
                      }
                      alt={`${member.name}`}
                    />
                  ...
                  <div className="flex-row flex dark:text-gray-400 justify-around mt-6">
                    ...
                    {member.twitter != null && (
                      <a target="_blank" rel="noreferrer" href={member.twitter}>
                        <svg
                          className="w-7 h-7 dark:fill-current"
                          viewBox="0 0 24 24"
                        >
                          <path
                            fill="#1DA1F2"
