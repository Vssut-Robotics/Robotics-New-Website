        ...
        <div className="mx-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 dark:bg-gray-800 dark:bg-opacity-0 text-black dark:text-gray-200 text-lg">
              ...
              <div className="mt-4">
                <ul>
                  <li className="border-b-2 border-red-600 pb-4 ">
                    2020: Shortlisted in Round 2-Abu Robocon 2020
                  </li>
          ...
          <div className="pricing p-5 mb-5 md:mb-10 shadow-lg dark:bg-gray-800">
            ...
            <div className="leading-tight">
              <div className="mt-4">
                <ul>
                  <li className="border-b-2 border-red-600 pb-3 ">
                    5 Teams selected for National finals at L&T Techgium, 2020
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    2 Teams selected for finals at KPIT Sparkle 2020
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    AIR 4 in MathWorks Parrot MiniDrone Competition-2019 , NUMA
                    Bengaluru
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                  ...
                  <li className="pt-2 ">
                    {" "}
                    2018-2nd prize at INFOSYS Robotics Camp,Bhubaneswar for our
                    project on UAV
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-4">
                <ul>
                  <li className="border-b-2 border-red-600 pb-5 ">
                    2020: 2 Participants got Internship at IIT Bombay
                  </li>
              ...
              <div className="mt-4">
                <ul>
                  <li className="border-b-2 border-red-600 pb-2 ">
                    2019- AIR 1 in SONAROUS at National Student's Space
                  ...
                  <li className="border-b-2 border-red-600 py-2 ">
                    2018- 1st prize in Line Follower and Balance Bot Event- NIT
                    ROURKELA
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                  ...
                  <li className="border-b-2 border-red-600 py-2 ">
                    2018- 2nd Runner-Up Position in Kolkata Zonal of Techfest,
                    IIT Bombay
                  </li>
                  <li className="pt-2 ">
                    2018- 1st Prize in Robotics Event at Techfest-IIT
                    Bhubaneswar
                  </li>
                  {/* <li className="border-b-2 border-red-600 py-2 ">
                    2017- 3rd prize at National Student’s Space Challenge – IIT
                    Kharagpur and ISRO
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    NIT Rourkela 2016 INNOVISION : 1st in Drone Wars &
                    Tread-O-Quest
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    NIT Rourkela 2016 INNOVISION : 2nd prize in Death Race
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    National Robotics Competition 2015: AIR-27
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    IIT Kharagpur 2015: 3rd position in Aerial Event
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    IIT Delhi: 3rd prize in Automatic Event (ROBOTRYST)
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    Robotics Event IIT BHubaneswar: 1st Position
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    IIT Kharagpur 2014: 2nd Position in Water Event(Boyant)
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    NIT Rourkela 2014: 1st position automatic Robotic
                    Competition(Tred-o-Quest)
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    NIT Rourkela 2014: 2nd Position at NIT Rourkela in
                    Underwater Robotics
                  </li>
                  <li className="border-b-2 border-red-600 py-2 ">
                    Kshitij IIT Kharagpur 2008: 1st Position
                  </li>
                  <li className="pt-2 ">
                    NEXUS,IIT Bombay 2008: 2nd Position
                  </li> */}
                </ul>
              </div>
            </div>
