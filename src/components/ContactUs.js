const Contact = () => {
    return (
      <div class="relative flex items-top justify-center pb-20 bg-white dark:bg-gray-900 sm:items-center sm:pt-0">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 pt-10">
